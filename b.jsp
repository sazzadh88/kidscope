...
<h:graphicImage id="grdmess2"  style="height:5px" value="#{grds.onlineimage}" />
</h:column>
</h:dataTable>
<h:commandButton  id="cmdlog"   action="#{friendsample.getchatlistdata}" value="Send"  >
<f:setPropertyActionListener value="#{sessionScope.sa}" target="#{friendsample.friend}" /> 
</h:commandButton>
