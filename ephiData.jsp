...
<%@page import="kids.dealer;import javax.faces.context.FacesContext;import javax.faces.context.FacesContext;import java.util.Map;"%>
...
String redirectURL = "dlrephimeris.faces";
response.sendRedirect(redirectURL);
	...
	//ses.put("dealern",request.getParameter("dlr"));
   	kids.dealer dlr=new kids.dealer();
   	String ipAddress=request.getRemoteAddr();
   	ses.put("secip",ipAddress);
	if(dlr.isValidDealerRun(request.getParameter("dlr"),request.getParameter("key"),ipAddress)==true)
	{
		...
		response.sendRedirect("dlrephimeris.faces");
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="20%" valign="top" class="rgt"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td class="bg" id="dec1"><h:commandLink value=" Manage Users" action="#{admin.manageuser}" immediate="true" styleClass="gen"></h:commandLink></td>
                  </tr>
                  <tr>
                    <td class="bg" id="dec1"><h:commandLink value="Manage Reports" action="#{admin.managereport}" immediate="true" styleClass="gen"></h:commandLink></td>
                  </tr>
              </table></td>
