...
<link rel="stylesheet"  media="print" type="text/css" href="stylesheet/print0.css" />
...
<h:form >
 <table width="96%" border="0" align="center" cellpadding="2" cellspacing="2">
        <tr>
          <td colspan="2" ><div id="prn1" onclick="MM_showHideLayers('prn1','','hide','prn','','show')"><table width="96%" border="0" cellpadding="2" cellspacing="2">
            <tr>
              <td width="84%">&nbsp;</td>
                <td width="5%">&nbsp;</td>
                
                <td width="6%" align="center"> <a href="Javascript:self.print()"><img src="images/print.png" alt="Print" width="28" height="28"  /></a></td>
  ...
  <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td>
        ...
        <tr>
          <td class="txt"><b><h:outputLabel id="add" value= ""></h:outputLabel></b>
         <h:outputLabel id="sd" value=""></h:outputLabel></td>
        </tr>
<tr><td>&nbsp;</td></tr>
...
<tr> <td>       
 <table align="left" cellpadding="1" cellspacing="1" border="1"  width="630px" >       
        <tr> 
...
<td class="txt"><h:outputLabel id="ss" value="#{grahanila.fdasa}"></h:outputLabel></td>
 ...
 <tr><td>&nbsp;</td></tr>
<tr><td class="h3"><b><h:outputText value=" #{grahanila.character}" ></h:outputText></b></td></tr>
<tr>
<td height="5"></td>
</tr>
...
<tr><td  class="h3" colspan="2"><b><h:outputText  value="#{grahanila.health}" ></h:outputText></b></td></tr>
<tr>
<td height="5"></td>
</tr>
...
<tr><td  class="h3" colspan="2"><b><h:outputText  value="#{grahanila.job}" ></h:outputText></b></td></tr>
<tr>
<td height="5"></td>
</tr>
...
<tr><td  class="h3" colspan="2"><b><h:outputText  value="#{grahanila.diet}" ></h:outputText></b></td></tr>
<tr>
<td height="5"></td>
</tr>
...
<tr><td  class="h3" colspan="2"><b><h:outputText  value="#{grahanila.remedy}" ></h:outputText></b></td></tr>
<tr>
<td height="5"></td>
</tr>
...
<tr><td><table width="96%" border="0" align="center" cellpadding="3" cellspacing="3">
<tr><td align="right"><img src="images/kidslogo.jpg" width="128" height="36"></td>
</tr>
</table>
